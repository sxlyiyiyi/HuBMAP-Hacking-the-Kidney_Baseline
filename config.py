...
cfg = _C
_C.MODEL_NAME = 'unet'
_C.BACKBONE_NAME = 'seresnext50'
_C.CKPT_DIR = './checkpoint/' + _C.MODEL_NAME + '_' + _C.BACKBONE_NAME
_C.LOG_DIR = _C.CKPT_DIR + '/logs'

_C.TRAIN = CN()
_C.TRAIN.BATCH_SIZE = 16
_C.TRAIN.EPOCHS = 1000
_C.TRAIN.ACTIVATION = 'sigmoid'
_C.TRAIN.ENCODER_WEIGHTS = 'imagenet'
...
_C.DATASET = CN()
_C.DATASET.TRAIN_DATA = './dataset/record/train.record*'
_C.DATASET.VAL_DATA = './dataset/record/val.record*'
_C.DATASET.RAW_SIZE = (512, 512)
_C.DATASET.SIZE = (512, 512)
